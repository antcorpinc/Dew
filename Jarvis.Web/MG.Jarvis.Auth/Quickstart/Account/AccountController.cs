...
namespace IdentityServer4.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        private readonly SignInManager<JarvisUser> _signInManager;
        ...
        public AccountController(
            UserManager<JarvisUser> userManager,
            SignInManager<JarvisUser> signInManager,
        ...
        public async Task<IActionResult> ExternalLoginCallback()
        {
            ...
            if (name == null) name = user.Id.ToString();
